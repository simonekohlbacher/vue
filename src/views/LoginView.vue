      ...
      <div class="card-body">
        ...
        <div class="flex items-center flex-col gap-2 mt-2 w-full">
          ...
          <label class="input validator w-full">
            ...
            <input v-model="password" @keydown.enter="handleLogin" type="password" required placeholder="Passwort" minlength="8" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must be more than 8 characters, including number, lowercase letter, uppercase letter" />
          </label>
        </div>
