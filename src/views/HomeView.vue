...
const { totalDiff, totalEstimate, totalCosts, fetchAllTasks, formatCurrency } = useTasks()
...
<template>
  <AppNavigation>
    ...
    <div class="sm:p-20">
      ...
      <p>
        Hier siehst du alle deine Projektkategorien auf einen Blick. Verwalte sie, füge neue hinzu
        und behalte deine Baustelle im Griff. Das Bearbeiten einer Kategorie kannst direkt in der
        jeweiligen Detail-Ansicht mit Klick auf das jeweilige Feld vornehmen. Der Status
        aktualisiert sich je nach Fortschritt der Aufgaben der jeweiligen Kategorie.
      </p>
      <div class="my-6">
        <AddCategory />
      </div>
      ...
      <div class="mb-6 p-4 rounded-lg shadow-sm border">
        <dl class="space-y-2">
          ...
          <div class="flex justify-between">
            ...
            <dd
              :class="
                totalDiff >= 0 ? 'text-red-600 font-semibold' : 'text-green-600 font-semibold'
              "
            >
